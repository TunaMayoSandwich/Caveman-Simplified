...
No filler/hedging Full sentences
Drop articles Fragments allowed Classic caveman
Abbreviate terms DB auth config req res fn impl , strip conjunctions, arrows (X → Y), single words when possible
...
max - Drop filler Full sentences| Default Drop articles pleasantries
Extreme compression Bare fragments
